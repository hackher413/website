...
export const sponsors: Sponsor[] = [
  // Current sponsors
  { name: "Manning CICS", url: "https://www.cics.umass.edu/", logo: "/sponsors/manning-cics.webp", tier: "current" },
  { name: "WFUM", url: "https://womenforumass.org/wfum/", logo: "/sponsors/wfum.webp", tier: "current" },
  ...
  { name: "Subway", url: "https://www.subway.com/", logo: "/sponsors/subway.webp", tier: "contributor" },
  { name: "Incogni", url: "https://incogni.com/", logo: "/sponsors/incogni.png", tier: "contributor" },
  { name: "Wolfram", url: "https://www.wolfram.com/", logo: "/sponsors/wolfram.webp", tier: "contributor" },
  ...
  { name: "Echo3D", url: "https://www.echo3d.com/", logo: "/sponsors/echo3d.webp", tier: "partner" },
];
...
> = {
  current: {
    ...
    // Featured tier uses centered flex on the page; columns unused.
    columns: "",
  },
  past: {
    label: "Past sponsors",
